...
% Blåtand (till PC), USB-UART (till styr, sensor), brytare
\subsection{Styrenhet}
% USB-UART (KoK-enhet), UART (servo), PWM+DIR (motorer)
\subsection{Sensorenhet}
% Trigger+echo (avståndssensorer, om ultraljud), analogt (avståndssensorer, om IR), PWM/I2C (LIDAR), Analog/I2C (om IMU)
