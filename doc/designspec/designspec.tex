...
\subsubsection{Tillstånds diagram}
...
Eftersom att styrenheten ska kunna arbeta medans kommandon läses in och skrivs ut blir det svårt att undvika parallella trådar. Totalt ska det behövas 4 olika trådar med följande uppgifter:

\newpage
\begin{enumerate}
	\item Läsa in data kontinuerligt från bussen och sätta navigerings instruktionen som ska läsas in till styrenheten.
	\item Skicka ut konstant information om styrenheten, t.ex. motorernas status, nuvarande tillstånd, etc.
	\item Styrenhetens logik
	\item Skicka och avläsa data till motorer. Dvs att formulera de instruktioner som ska skickas till respektive protokoll. Anledningen till att det inte är en till tråd separat för AX-12 servon är för att den aldrig kommer köras samtidigt som DC-motorerna.
\end{enumerate}
