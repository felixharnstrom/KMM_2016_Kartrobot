...
Vid särskilda tidspunkter i projektet så intergreras moduler. Var då vänliga att referera till tidsplanen. Grupper är fria att testa gentemot varandra tidigare än så om de är överrens. Sent i projektet sker systemtest, och tid ges för att fixa de fel som uppkommer.
