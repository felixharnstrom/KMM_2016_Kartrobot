...
\begin{figure}[h!]
	...
	\caption{Plasering av IR-sensorer, samt LIDAR.}
...
\begin{figure}[h!]
	\makebox[\textwidth][c]{\includegraphics[width=0.6\textwidth]{sensorenheten-flow_shart.png}}
...
Begär avläsning av rummet -> Bearbeta data -> Skicka data vidare

Mät avstånd framåt -> Reagera när avståndet är väldigt kort -> Flagga
...
Begär rotationsdata -> Bearbeta data -> Skicka vidare rotationsdata
...
Begär avläsning -> Ta tid -> Konvertera till avstånd -> Jämför sensor 1 och sensor 2 avstånd samma sida => Om samma -> Begär ny avläsning => Om inte samma -> Begär korigering -> Begär ny avläsning
