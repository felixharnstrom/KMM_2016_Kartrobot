...
I det manuella läget tar roboten emot kommandon från PC:n via blåtand (se kapitel \ref{sec:system4}) om hur den ska åka, mycket likt en radiostyrd bil. Dessa kommandon är relativt högnivå, exempel presenteras nedan:
