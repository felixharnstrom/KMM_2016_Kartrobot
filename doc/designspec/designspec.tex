...
\item Hobbyservot kommunicerar över PWM vilket är betydligt enklare att implementera än half-duplex. Svängvidden för hobbyservon brukar vara runt 180 grader. Vi använder dock gärna ett med större svängvidd för att behöva scanna färre gånger.
\end{itemize}
