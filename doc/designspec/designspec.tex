...
Sensorenheten innehåller en processor av modellen ATmega1284, flera IR-sensorer, en lasersensor, samt gyro.
IR-sensorerna används primärt för navigering, så att roboten har lättare att köra i en rak linje längst en vägg. Lasersensorn används för analys av rummet. Med hjälp av gyrot är det lättare att hålla koll på rotationen av roboten.
