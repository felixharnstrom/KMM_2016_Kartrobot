...
ATmega1284 används som processormodell, då den är kraftfull utan att ta det till överdrift. Antalet pinnar som processorn har räcker gott och väl för att koppla in samtliga sensorer.
