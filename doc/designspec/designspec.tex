...
Sensorenheten innehåller en processor av modellen ATmega1284, samt flera ultraljudssensorer, en lasernsensor, samt gyro.
Ultraljudssensorer används primärt för navigering, så att robotten har lättare att köra i en raklinje längst en vägg. Lasersensorn används för analys av rummet. Med hjälp av gyrot är det lättare att hålla koll på rotationen av robotten.
...
\subsubsection{IR-sensor} \label{sssec:sonicsensors}
