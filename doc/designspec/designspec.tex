...
På toppen av roboten ska en lasersensor (se \ref{sssec:lidar}) vara monterad, ovanpå en servo som tillåter sensorn att rotera. Servomotorn är en AX-12(+/A) och har två rotationslägen: ''vanlig'' och ''wheel''. 
...
Vi implementerar en UART-buss som går mellan styrenheten och kommunikationsenheten. Se sektion \ref{ssec:brainInterface} för mer detaljer om för och nackdelar.
