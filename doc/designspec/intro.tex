...
I detta projekt konstrueras en robot med förmågan att kartlägga rum som specificeras enligt \cite{coursespec}. Detta ska den göra genom att förflytta sig i rummet (med manuell eller autonom styrning) och skanna med en avståndskänslig laser. Kommandon och resultat skickas till respektive från en extern PC via ett blåtandsgränssnitt.
...
\begin{figure}[h!]
    \makebox[\textwidth][c]{\includegraphics[scale=0.40]{layout_topdown.png}}
