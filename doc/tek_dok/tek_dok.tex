...
Sensorerna som skickar analoga signaler ger väldigt dåliga mätvärden, mycket för att det är svårt att filtrera allt brus. Det hade varit till stor fördel att använda digitala sensorer istället.

LIDARN hade varit helt onödig om man istället använt IR-sensorer med 5-100 cm räckvidd. Köksön hade då kunnat scannas med IR-sensorerna och LIDARN hade blivit helt onödig.
