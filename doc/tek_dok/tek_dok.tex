...
\label{ssec:brainInterface}
Kommunikation- och kontrollenheten använder sig av seriella bussar för datautbyte mellan sensorenhet och styrenhet. Mjukvara för dessa krävs på båda håll. Utbyte av data sker åt båda hållen; sensorenheten skickar data på kommando, och styrenheten tar antingen emot ett styrkommando som inte returnerar något värde, alternativt ett kommando för att få ut styrdiagnostisk som då returneras från styrenheten.
