...
\label{tab:documents}
\begin{tabular}{|L{90pt}|L{40pt} |L{60pt} |L{70pt} |L{80pt} |}
	\hline
...
Rapporter kommer att skrivas, så att beställaren kan få en bild av hur projektet löper frammåt, samt om tidsplanen följs. Det kommer att finnas färdiga mallar så att dem blir lätta och smidiga att skapa. Dokumentansvarig har ansvaret att dessa skapas och projektledaren har huvudansvaret för rapporterna. % TODO: Pratar vi om typ teknisk dokumentation, eller "statusrapporter"? Om statusrapporter: Var står det att vi ska skriva sånna?
...
%TODO Är det ens värt att nämna detta om vi inte samtidigt beskriver hur vi ska reagera om situationen uppstår? //Felix, +1 /SL
...
%//Felix
% Röstar för att byta listan mot texten /SL
