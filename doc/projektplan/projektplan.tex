...
\newcommand{\LIPSgranskare}{Emil Norberg}
\newcommand{\LIPSgranskatdatum}{2016-09-22}
...
\begin{appendices}
\includepdf[scale=1.2,offset=60pt 100pt,pagecommand=\section{Tidplan}\label{app:tidplan}]{tidsplanering.pdf}
\end{appendices}
\clearpage
