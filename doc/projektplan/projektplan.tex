...
\begin{document}
    ...
    Produkten är vid slutleverans begränsad till de krav som är formulerade i den senaste versionen av kravspecifikationen. Kravspecifikationen kan inte uppdateras utan överrenskommelse med beställaren.
    ...
    \label{sec:doc_plan}
    % TODO: Enbart gruppmedlemmar ska ha access till dokument? Vad om de som delas med beställare?
    % Kan tycka att den parantesen är onödig.
    ...
    % TODO: Glöm inte fixa listan här!
    %\begin{itemize}
    ...
    %	\item 2st brytare
    %	\item Dator
    %	\item Robotplattform med hjul, motorer och batteri.
    %	
    %	\item 1st LSM9DS0
    %\end{itemize}
    ...
    %% TODO borde vara en tabell och det borde finnas fler risker
