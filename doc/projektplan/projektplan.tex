...
\label{tab:documents}
Alla dokumenten distributeras både till Mattias och hela gruppen.
% TODO måste bli en tabell, jag klarar inte av att skapa tabeller
Dokument  Ansvarig  Godkänns av  Syfte  Färdig
Systemskiss  PL  Mattias  Underlag för designspecifikationen  2016-09-30
Tidsplan  PL  Mattias  Hjälpmedel under projektet  2016-09-30
Projektplan  PL  Mattias  Hjälpmedel till hur projektet utförs  2016-09-30
Tidsrapporter  DOK  Mattias  Så att vi kan se att alla har bidragit  Varje måndag
Uppdaterad tidsplan  DOK  Mattias  Så att vi kan se hur projektet ligger till  Varje måndag
Statusrapport för projektet  DOK  Mattias  Så att vi kan se hur projektet ligger till  Vid begäran
Designspecifikation  MV, HV  Mattias  Underlag för konstruktion  2016-11-04
Teknisk dokumentation  DOK  Mattias  Dokumentera dem tekniska lösningarna  3 dagar för redovisning
Användahandledning  DOK  Mattias  Manual om hur den används  3 arbetsdagar för redovisning
Efterstudie dokument  PL  Mattias  Reflektera över projektet  2016-12-21
