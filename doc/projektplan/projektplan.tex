...
\begin{flushleft}
    \begin{LIPSaktivitetslista}
        ...
        \LIPSaktivitet{14}{Gränssnitt mellan kontroll- och sensormodul}{Implementera gränssnitt för USB-UART mellan kontrollmodul och sensormodul.}{4, 13}{10}
        ...
        \LIPSaktivitet{28}{Test av system}{Utförliga tester av roboten för att säkerställa att dess funktionalitet är pålitlig.}{29}{40}
