...
LEV ansvarar att alla leveranser sker vid utsatt tid. 
\begin{flushleft}
...
\label{tab:documents}
% TODO måste bli en tabell, jag klarar inte av att skapa tabeller
Dokument  Ansvarig  Godkänns av  Syfte  Distribueras till  Färdig
Systemskiss  PL  Mattias  Underlag för designspecifikationen  Mattias och Gruppen  2016-09-30
Tidsplan  PL  Mattias  Hjälpmedel under projektet  Mattias och Gruppen  2016-09-30
Projektplan  PL  Mattias  Hjälpmedel till hur projektet utförs  Mattias och Gruppen  2016-09-30
Tidsrapporter  DOK  Mattias  Så att vi kan se att alla har bidragit  Mattias och Gruppen  Varje måndag
Uppdaterad tidsplan  DOK  Mattias  Så att vi kan se hur projektet ligger till  Mattias och Gruppen  Varje måndag
Statusrapport för projektet  DOK  Mattias  Så att vi kan se hur projektet ligger till  Mattias och Gruppen  Vid begäran
Designspecifikation  MV, HV  Mattias  Underlag för konstruktion  Mattias och Gruppen  2016-11-04
Teknisk dokumentation  DOK  Mattias  Dokumentera dem tekniska lösningarna  Mattias och Gruppen  3 dagar för redovisning
Användahandledning  DOK  Mattias  Manual om hur den används  Mattias och Gruppen  3 arbetsdagar för redovisning
Efterstudie dokument  PL  Mattias  Reflektera över projektet  Mattias och Gruppen  2016-12-21
...
%TODO Är det ens värt att nämna detta om vi inte samtidigt beskriver hur vi ska reagera om situationen uppstår? //Felix

%% TODO det borde finnas fler risker. Beskriv skalan.
\begin{tabular}{l l l}
...
\begin{enumerate}
        \item Färdigt v 51
        \item Funktionalitet %TODO: Menar man prio-2-funktionalitet?
        \item Kostnad %TODO: Tid är vår enda resurs. Ska vi prioritera det genom att bara sluta jobba?
        \item Resurser %TODO: Again, tid är vår enda resurs
        \item Kvalitet %TODO: Menas finare kod? Att den klarar labyrinter mer konsekvent? Att det är bättre i tävlingen?
        \item Estetiskt utseende
    \end{enumerate}
    
%Alternativt löpande text:
