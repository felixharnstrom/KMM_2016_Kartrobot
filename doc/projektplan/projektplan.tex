...
\subsection{Lokaler}
Gruppen har tillgång till minst en arbetsstation i laborationsytan MUXEN och där kan vid behov samtliga 6 medlemmar jobba. Vid behov kan grupplokaler bokas kostnadsfritt på unniversitetet.
...
I detta kapitell förklaras vilka milstolpar, samt beslutspunkter som finns.

\subsection{Milstolpar}
\begin{itemize}
	\item Gränsnittet mellan sensorer och moduler klart
	\item Dator GUI klart
...
%% TODO fixa en tabell, första kolumn NR (numren ska börja från 0), andra bör vara BESKRIVNING och tredje DATUM
Godkännande av projektet, beslut startar förstudie 2016-09-01
Godkännande av kravspecifikation, beslut startar förberedelsefasen 2016-09-13
Godkännande av projektplan, tidspal och systemskiss, beslut startar utförandefasen 2016-09-29
Godkännande av designspecifikation, beslut att fortsätta utförandefasen 2016-11-04
Verifering av kraven, samt godkännande av produktens funktionalitet, beslut leder till leveransfasen | Senast en dag innan presenation
Godkännande av produktleverans, samt presentation och demonstartion, leder till beslut att upplösa projektgruppen v51
