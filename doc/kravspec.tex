...
Vår produkt är en robot som kan navigera genom en 6$ \times $6m bana och kartlägga hur banan ser ut. Roboten ska ha två olika lägen; ett då den styrs med hjälp av Blåtand, ett annat då den är självkörande och kartlägger banan själv. Roboten ska även oavsett läge alltid skicka information angående sin status dvs data från sensorer, robotens läge etc. 
...
\begin{LIPSkravlista}
    ...
    \LIPSkrav{Original}{Sensorenheten ska kunnna skicka en nödstoppssignal.}{2}
\end{LIPSkravlista}
...
\begin{LIPSkravlista}
    ...
    \LIPSkrav{Original}{Sensorenheten ska kunnna ta emot en nödstoppssignal.}{2}
\end{LIPSkravlista}
...
\begin{LIPSkravlista}
    ...
    \LIPSkrav{Original}{Enheten skickar sensor och motordata till PCn via Blåtand.}{1}
\end{LIPSkravlista}
...
\begin{LIPSkravlista}
    ...
    \LIPSkrav{Original}{Sensorernas värden och robotens status ska skickas tas emot över Blåtand och presenteras för navigeraren.}{1}
...
\section{Banspecifikation} \label{sec:courseSpecification}
...
\subsection{Enligt projektdirektiv}
\begin{itemize}
...
\section{Tävlingsregler} \label{sec:competitionRules}

\subsection{Tävlingsupplägg}
\begin{LIPSAppendixKravlista}
