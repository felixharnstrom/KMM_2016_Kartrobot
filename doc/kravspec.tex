...
\begin{LIPSkravlista}
	...
	\LIPSkrav{Original}{Roboten ska uppfylla kraven i appendix A.}{1}
	...
	\LIPSkrav{Original}{Roboten ska kunna kartlägga ett rum som specificerat i appendix A.}{1}
\end{LIPSkravlista}
...
\begin{LIPSkravlista}
	\LIPSkrav{Original}{Roboten ska kunna kartlägga ett rum som specificerat i appendix A på under 20 minuter}{1}
...
\begin{LIPSleveranslista}	
	...
	\LIPSleverans{Original}{Första versionen av projektplan, tidplan och systemskiss}{2016-09-23}{Utgått}
