...
\begin{LIPSkravlista}
    ...
    \LIPSkrav{Original}{En sensor ska användas för kalibrering den sensor som roterar för avläsning av rummet.}{2} %TODO Behövs verkligen det eller ska vi använda ett gyro?
