...
\begin{LIPSkravlista}
    ...
    \LIPSkrav{Original}{När styrenheten översätter högnivåinstruktioner till motorsignaler ska dessa rapporteras tillbaka via en enskild buss.}{2}	%TODO redundant? är ju redan ett prio-1 krav att rapportera styrdata till kontrollenheten
...
\subsection{Funktionella krav}
\begin{LIPSkravlista}
	\LIPSkrav{Original}{Kontrollenheten ska bestämma en lämplig färdväg.}{1}
    \LIPSkrav{Original}{Kontrollenheten ska bestämma lämpliga styrinstruktioner för att navigera genom rummet.}{1}
\end{LIPSkravlista}
