...
Sensorenheten behandlar data från olika sensorer, för att sedan föra den vidare på ett läsligt format till styrenheten, delsystem 3.\\ %TODO Vad menas här?
\begin{LIPSkravlista}
    \LIPSkrav{Original}{Det ska sitta avståndssensorer på robotens sidor.}{1}
    \LIPSkrav{Original}{Det ska finnas nödstopps-funktionalitet.}{2}
    ...
    \LIPSkrav{Original}{En sensor ska användas för kalibrering av graderna på den sensor som roterar för avläsning av rummet.}{2} %TODO Behövs verkligen det eller ska vi använda ett gyro?
...
\begin{LIPSkravlista}
    ...
    \LIPSkrav{Original}{Sensorenheten ska ta emot sensordata från avståndssensorerna och gyrot.}{1} %TODO Plural?
\end{LIPSkravlista}
...
\begin{LIPSkravlista}
    ...
    \LIPSkrav{Original}{Styrenheten ska styra servomotorerna xxx.}{1}
    \LIPSkrav{Original}{Styrenheten ska kunna översätta högnivåinstruktioner som exempelvis ''hastighet n rakt fram'' och ''sväng 10 grader åt höger'' till motorsignaler.}{2} %TODO Borde inte detta vara prio 1?
\end{LIPSkravlista}
...
\begin{LIPSkravlista}
    ...
    \LIPSkrav{Original}{Enheten ska kunna skicka motorinstruktioner på hög nivå, t.ex. ''hastighet n rakt fram'' och ''sväng 10 grader åt höger''. }{2} %TODO borde inte den här prioriteten vara omvänd? (Det borde vara enklare att hantera det omvända fallet?)
...
\subsection{Designkrav}
\begin{LIPSkravlista}
    \LIPSkrav{Original}{Kontrollenhetens mjukvara ska vara skriven i Python.}{1}
...
\subsection{Designkrav}
\begin{LIPSkravlista}
    \LIPSkrav{Original}{Mjukvaran ska vara skriven i Python.}{1}
