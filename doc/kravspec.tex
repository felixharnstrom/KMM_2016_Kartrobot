...
\begin{LIPSkravlista}
    ...
    \LIPSkrav{Original}{Enheten ska kunna skicka motorinstruktioner på hög nivå, t.ex. ''hastighet $n/max$ rakt fram'' och ''sväng $n$ grader åt höger''. }{2} %TODO borde inte den här prioriteten vara omvänd? (Det borde vara enklare att hantera det omvända fallet?)
