...
Att leverera en kartrobot som kan styras manuellt via Blåtand, samt autonomt navigera en bana uppbyggd enligt \href{\CourseSpecUrl}{Ban- och tävlingsspecifikationen} och samtidigt rita upp en karta över området.  
...
I det autonoma läget ska roboten utforska en bana som är uppbyggd enligt \href{\CourseSpecUrl}{Ban- och tävlingsspecifikationen}. Den ska skicka data till en ansluten dator, som ritar upp en karta över området. Efter kartläggningen ska roboten återvända till startområdet. 

\section{Översikt av systemet}
Vår produkt är en robot som kan navigera genom en rum som är specificerat i \href{\CourseSpecUrl}{Ban- och tävlingsspecifikationen} och kartlägga hur banan ser ut. Roboten ska ha två olika lägen; ett då den styrs manuellt med hjälp av Blåtand och ett annat då den är självkörande och kartlägger banan själv. Roboten ska även oavsett läge alltid skicka information angående sin status, diverse data från sensorer, robotens läge med mera. 
...
Behöver endast klara av banor utformade enligt \href{\CourseSpecUrl}{Ban- och tävlingsspecifikationen}. 
...
\begin{LIPSkravlista}
    ...
    \LIPSkrav{Original}{Roboten ska kunna ställa upp i  en tävling som definieras via \href{\CourseSpecUrl}{Ban- och tävlingsspecifikationen}.}{1}
    ...
    \LIPSkrav{Original}{Roboten ska kunna kartlägga ett rum som specificerat i \href{\CourseSpecUrl}{Ban- och tävlingsspecifikationen}.}{1}
\end{LIPSkravlista}
...
\begin{LIPSkravlista}
    \LIPSkrav{Original}{Roboten ska klara tre på varandra följande rumsskanningar enligt reglerna speficerat i \href{\CourseSpecUrl}{Ban- och tävlingsspecifikationen} utan tidstillägg.}{1}
\end{LIPSkravlista}
