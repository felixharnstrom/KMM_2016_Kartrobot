...
\begin{LIPSdokumenthistorik}
    \LIPSversionsinfo{0.1}{2016-09-07}{Första utkastet}{FH}{FH}
...
Vid manuell styrning så ska roboten reagera på följande kommandon som skickas via Blåtand. 
...
Vår produkt är en robot som kan navigera genom en rum som är besifiserad i bilaga \ref{sec:courseSpecification} och kartlägga hur banan ser ut. Roboten ska ha två olika lägen; ett då den styrs manuellt med hjälp av Blåtand och ett annat då den är självkörande och kartlägger banan själv. Roboten ska även oavsett läge alltid skicka information angående sin status, diverse data från sensorer, robotens läge med mera. 
...
\begin{LIPSkravlista}
    ...
    \LIPSkrav{Original}{Roboten ska kunna ställa upp i  en tävling som defineras i bilaga \ref*{ssec:competitionRules}.}{1}
...
\begin{LIPSkravlista}
    ...
    \LIPSkrav{Original}{En roterande avståndsssensor ska sitta på toppen av robotten.}{1}
...
\begin{LIPSkravlista}
    ...
    \LIPSkrav{Original}{Kontrollenheten ska kunna skicka motorinstruktioner på hög nivå, t.ex. ''hastighet $n/max$ rakt fram'' och ''sväng $n$ grader åt höger''. }{1} 
    \LIPSkrav{Original}{Kontrollenheten ska kunna ta emot en signal från en brytare.}{1}
...
\begin{LIPSkravlista}
    ...
    \LIPSkrav{Original}{Robotens och sensorernas status samt den hitintills genererade kartan presenteras, samt uppdateras kontinuerligt i mjukvaran.}{2}
\end{LIPSkravlista}
...
\begin{LIPSkravlista}
    \LIPSkrav{Original}{Vi ska klara tre på varandra följande rumsskanningar.}{2}
\end{LIPSkravlista}
