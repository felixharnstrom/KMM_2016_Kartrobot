...
Koden ska vara skriven i C, och ska följa standarden specificerad i bilaga \ref{sec:cstandard}. Funktioner ska vara kommenterade.
...
\begin{itemize}
    ...
    \item Dokumentationskommentarer f;r funktioner och dylikt ska inledas med "/*" följt av tom rad, med textrader inledda med "{ }* ". Hela kommentaren avslutas med en rad som endast innehåller "{ }*/".
\end{itemize}
