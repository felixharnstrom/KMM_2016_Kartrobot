...
\begin{LIPSprojektidentitet}
    % TODO: Förkortningar
    % TODO: Är roller korrekta?
    \LIPSgruppmedlem{Hannes Haglund}{Designansvarig mjukvara}{hanha265@student.liu.se}
    \LIPSgruppmedlem{Felix Härnström}{Projektledare (PL)}{felha423@student.liu.se}
    \LIPSgruppmedlem{Jani Jokinen}{Leveransansvarig}{janjo273@student.liu.se}
    \LIPSgruppmedlem{Silas Lenz}{Testansvarig}{sille914@student.liu.se}
    \LIPSgruppmedlem{Daniel Månsson}{Designansvarig hårdvara}{danma344@student.liu.se}
...
LIDAR är en kraftfull lasersensor som i systemet som helhet används för mätningar som kräver en viss grad av noggranhet. Komponenten kan kommuniceras med via en I\textsuperscript{2}C-buss, som därmed ska användas, se sektion \ref{ssec:sensorInterface}. Processorn behöver mjukvarustöd för detta. % TODO: Varför använder vi inte PWM?
