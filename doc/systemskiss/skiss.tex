...
Detta delsystem kommunicerar med Kommunikations- och kontrollenheten (se \ref{sec:system3}) för att ta emot avlusningsdata och ge instruktioner vid manuellt läge.
