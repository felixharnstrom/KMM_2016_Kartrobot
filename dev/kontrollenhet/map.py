...
def map_room(robot, map):
    ...
    #coordinates = read_debug_data('demo_data/perfect_square_right_front_corner.json')
...
# #
# #         for degree, dist in measurements:
# #             x_tmp = math.sin(math.radians(degree - 90)) * dist
# #             y_tmp = math.cos(math.radians(degree - 90)) * dist
# #             # x = np.append(x, [x_tmp])
# #             # y = np.append(y, [y_tmp])
# #             if ((x_tmp > 0) and (x_tmp < 400) and (y_tmp > 400) and (y_tmp < 800)):
# #                 x1 = np.append(x1, [x_tmp])
# #                 y1 = np.append(y1, [y_tmp])
# #             elif ((x_tmp > -400) and (x_tmp < 0) and (y_tmp > 400) and (y_tmp < 800)):
# #                 x2 = np.append(x2, [x_tmp])
# #                 y2 = np.append(y2, [y_tmp])
# #                 # print(x_tmp, y_tmp)
# #                 # x.append(x_tmp)
# #                 # y.append(y_tmp)
# #
...
#
#         # plotting
#         xp1 = np.linspace(0, 400, 100)
#         xp2 = np.linspace(400, 800, 100)
#         plt.plot(x1, x1, '.', xp1, p1(xp1))
#         plt.plot(x2, x2, '.', xp2, p2(xp2))
#         plt.show()
#
#     plt.show()
#
